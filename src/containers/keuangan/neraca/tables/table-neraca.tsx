...
import './table-keuangan.css'
import { Icon } from '@iconify-icon/solid';


const TableNeraca: Component = () => {
    ...
    const columnDefs = [
        ...
        { field: 'deskripsi' },
        { field: 'asetawal', headerName: 'Aset Awal' }, 
        { field: 'asetakhir', headerName: 'Aset Akhir' }, 
        { field: 'total' }
      ];
