...
import './confirm-delete-plan.css'

interface ComfirmDeletePlanProps {
    OnClose: () => void;
   // dataId: number;
}

const ComfirmDeletePlan: Component<ComfirmDeletePlanProps> = (props) => {
...
export default ComfirmDeletePlan;
