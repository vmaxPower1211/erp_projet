...
import './transfer_danaDU.css';
import { Icon } from '@iconify-icon/solid';
import Tabel_transfer_danaMonthly from './tabel_transfer_danaMonthly';
import { useSubNavbarStore } from "../../../../store/Navbar/SubNavbarStore";
import DashboardDU from '../dashboard-du';
import Tabel_transfer_danaEvent from './tabel_transfer_danaEvent';


const Transfer_danaDU: Component = () => {
        ...
        <div class="arus-kas">
            ...
            <div class="card-arus-kas">
                ...
                <div class="tableteams">
                    <h3 style={{"margin-left":"0.5rem"}}>Transfer Dana Monthly</h3>
                    <Tabel_transfer_danaMonthly />
                </div>

                <div class="tableteams2">
                    <h3 style={{"margin-left":"0.5rem"}}>Transfer Dana Event</h3>
                    <Tabel_transfer_danaEvent />
                </div>
...
export default Transfer_danaDU;